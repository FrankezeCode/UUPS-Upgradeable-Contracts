...
This is contract is built with Solidity and thorougly tested with Foundry.
...
```
git clone https://github.com/FrankezeCode/UUPS-Upgradeable-Contracts
...
If you appreciated this, feel free to drop a review!
